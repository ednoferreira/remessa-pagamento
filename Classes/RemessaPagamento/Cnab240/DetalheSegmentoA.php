...
class DetalheSegmentoA {
    ...
    public static function gerar($detalhe) {
        ...
        $linha .= setValor($detalhe['detalhe_cod_lote'], 4);
        ...
        // CÂMARA                      | CÓDIGO DA CÂMARA CENTRALIZADORA                      | 018 020   | 9(03)       | NOTA 37
        ...
        // N DE INSCRIÇÃO              | Nº DE INSCRIÇÃO DO FAVORECIDO (CPF/CNPJ)             | 204 217   | 9(14)       | NOTA 15
        $linha .= setValor($detalhe['detalhe_cpf_cnpj'], 14, ' ', 'esquerda');
        // FINALIDADE DOC E STATUS     |  FINALIDADE DO DOC E STATUS DO FUNCIONÁRIO NA EMPRESA| 218 219   | X(02)       |  NOTA 30
        ...
        $linha .= setValor($detalhe['detalhe_aviso'], 5);
