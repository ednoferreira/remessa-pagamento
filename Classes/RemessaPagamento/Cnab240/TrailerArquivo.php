...
/**
 * Gerar o trailer de Lote (rodapÃ© do arquivo)
 */
class TrailerArquivo {

    /**
     * Gerar o Header de Arquivo
     * legenda de conte?do: X = ALFANUM?RICO 9 = NUM?RICO V = VÍRGULA DECIMAL ASSUMIDA
     */
    public static function gerar($dados) {
        $linha = '';
        // NOME DO CAMPO               | SIGNIFICADO                                          |  POSI??O  | PICTURE    | CONTEÚDO
        //============================================================================================
